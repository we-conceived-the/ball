# Linearize
Construct a linear, no-fork, best version of the Ball blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install ball_hash

https://we-conceived-the/ball_hash
...
JSON-RPC server. Running `balld` or `ball-qt -server` will be sufficient.
...
* `input`: balld blocks/ directory containing blkNNNNN.dat
