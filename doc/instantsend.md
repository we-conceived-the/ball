...
This mechanism has been integrated into Bitcore-Node-Ball which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ballpay/insight-api-ball#web-socket-api](https://github.com/ballpay/insight-api-ball#web-socket-api)
* API: [https://github.com/ballpay/insight-api-ball#instantsend-transactions](https://github.com/ballpay/insight-api-ball#instantsend-transactions)
...
By default, the Ball Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ball Core daemon:
