...
//! These need to be macros, as clientversion.cpp's and ball*-res.rc's voodoo requires it
...
/**
 * balld-res.rc includes this file, but it cannot cope with real c++ code.
