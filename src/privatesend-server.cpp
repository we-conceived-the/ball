...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Ball related functionality
...
/*
    ...
    allow endless transaction that would bloat Ball and make it unusable. To
