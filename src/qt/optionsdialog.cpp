    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BALL-light"), QVariant("light"));
    ui->theme->addItem(QString("BALL-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BALL-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BALL-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BALL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BALL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BALL-traditional"), QVariant("trad"));
