    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  ball-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Ball in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BALL, 0.1 BALL, 1 BALL and 10 BALL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://ballpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://ballpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
