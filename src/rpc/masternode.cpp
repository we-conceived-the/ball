...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Ball address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "ball",               "masternode",             &masternode,             true,  {} },
    { "ball",               "masternodelist",         &masternodelist,         true,  {} },
    { "ball",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "ball",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "ball",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "ball",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
